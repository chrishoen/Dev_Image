...
StackObjectWriter::StackObjectWriter(SimParms* aParms)
{
   initialize(aParms);
}

void StackObjectWriter::finalize()
{
}
...
void StackObjectWriter::initialize(SimParms* aParms)
{
...
{
   Prn::print(0, "StackObjectWriter::doGenerateStack");
...
void StackObjectWriter::doCalculateStackSize()
{
   mStackSize = 0;
...
void StackObjectWriter::doApplyMorphFilter(MorphParms* aParms)
{
   // Guard.
...
void StackObjectWriter::doWriteOutputImage()
{
