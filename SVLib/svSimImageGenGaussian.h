...
Gaussian class for object point grid generators.
==============================================================================*/
...
public:
   ...
   SimImageGenGaussian();
   SimImageGenGaussian(SimImageGenParms* aParms);
   void reset();
