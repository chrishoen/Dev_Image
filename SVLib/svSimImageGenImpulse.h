...
Impulse class for object point grid generators.
==============================================================================*/
...
public:
   ...
   SimImageGenImpulse();
   SimImageGenImpulse(SimImageGenParms* aParms);
   void reset();
