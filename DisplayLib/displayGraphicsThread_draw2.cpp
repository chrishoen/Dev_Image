...
void GraphicsThread::doVideoDraw2(SDL_Event* aEvent)
{
   ...
   Prn::print(Prn::Vid1, "doVideoDraw2  %4d %4d", tImage->rows, tImage->cols);
   ...
   try
   {
      ...
      Prn::print(Prn::Vid4, "height        %4d", tIntelImage.height);
      Prn::print(Prn::Vid4, "width         %4d", tIntelImage.width);
      Prn::print(Prn::Vid4, "depth         %4d", tIntelImage.depth);
      Prn::print(Prn::Vid4, "nChannels     %4d", tIntelImage.nChannels);
      Prn::print(Prn::Vid4, "widthStep     %4d", tIntelImage.widthStep);
