...
public:
   ...
   void executeSetZip        (Ris::CmdLineCmd* aCmd);
   void executeLoadZip       (Ris::CmdLineCmd* aCmd);

   void executeDirGCode      (Ris::CmdLineCmd* aCmd);
   void executeSetGCode      (Ris::CmdLineCmd* aCmd);
   void executeLoadGCode     (Ris::CmdLineCmd* aCmd);
